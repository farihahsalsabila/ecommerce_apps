...
//
//     final restLogin = restLoginFromJson(jsonString);

import 'dart:convert';

RestLogin restLoginFromJson(String str) => RestLogin.fromJson(json.decode(str));

String restLoginToJson(RestLogin data) => json.encode(data.toJson());
...
class RestLogin {
  ...
  factory RestLogin.fromJson(Map<String, dynamic> json) => RestLogin(
