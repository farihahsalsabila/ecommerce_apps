...
//
//     final restGetKeranjang = restGetKeranjangFromJson(jsonString);

import 'dart:convert';

RestGetKeranjang restGetKeranjangFromJson(String str) => RestGetKeranjang.fromJson(json.decode(str));

String restGetKeranjangToJson(RestGetKeranjang data) => json.encode(data.toJson());

class RestGetKeranjang {
  RestGetKeranjang({
    this.message,
    this.status,
    this.dataKeranjang,
  ...
  factory RestGetKeranjang.fromJson(Map<String, dynamic> json) => RestGetKeranjang(
